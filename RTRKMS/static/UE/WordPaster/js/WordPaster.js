...
var WordPasterConfig = {
	...
	, "License"			    : "DAFB3AE12494FA2E2891238FC22E46AFA6437200A018115574E842DDC2B44DC4D57B0C6492B3C94F40ECC0C321"
	, "Debug"			    : false//调试模式
...
WordPasterManager = function (vm)
{
	...
	this.OpenDialogFile = function ()
	{
		...
		// this.dlglayer = layer.open({
		// 	type:1,
		// 	title:['信息','font-size:14px'],
		// 	area:['470px','400px'],
		// 	shade:0,
	...
	this.PasteManual = function ()
	{
	    ...
	    else
	    {
	        if (_this.WordParser.HasData()){
				...
				_this.Editor.execCommand('pastePlain');
			}
	    }
	};
